...
:: 2. Build and publish
call :ExecuteCmd dotnet publish "%DEPLOYMENT_SOURCE%\JoF.Rail.Core.Web\JoF.Rail.Core.Web.csproj" --output "%DEPLOYMENT_TEMP%" --configuration Release
IF !ERRORLEVEL! NEQ 0 goto error

:: 2a. (Inserted) Gulp
echo Moving to source directory
pushd "%DEPLOYMENT_SOURCE%\JoF.Rail.Core.Web"
...
call :ExecuteCmd "xcopy" "%DEPLOYMENT_SOURCE%\JoF.Rail.Core.Web\dist\*" "%DEPLOYMENT_TEMP%\dist" /S /Y /I
